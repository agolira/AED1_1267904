...
Data        : 20/08/2026
Objetivo    : responder se a matriz e solucao do sudoku ou nao. e inicializar as matrizes utilizando alocacao dinamica.
...
int verRepetido(int x,int y,int **matriz){
